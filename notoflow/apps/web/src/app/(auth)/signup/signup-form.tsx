...
import { signup, signInWith } from "../actions";
...
export function SignupForm() {
  ...
  const isPending = pending || isOauthPending;
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      <form action={formAction} className="space-y-4">
        ...
        <Button className="w-full rounded-lg h-10 font-medium mt-2" type="submit" disabled={isPending}>
